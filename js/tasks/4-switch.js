...
// 1. Запитуємо у користувача суму покупки та код знижки + перевірка
const totalAmount = parseFloat(prompt("Введіть суму покупки (грн):"));
const discountCode = parseInt(prompt("Введіть код знижки (1-5):"));
...
} else if (isNaN(totalAmount) || totalAmount <= 0) {       // ! попередженя якщо сума не вказана, від'ємна, або 0
